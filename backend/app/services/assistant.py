...
async def generate_response(
    ...
    def _call() -> tuple[str, dict[str, Any] | None, dict[str, Any] | None]:
        ...
        system_prompt = (
            ...
            "\n\n"
            "DISTANCE AND LOCATION GUIDELINES:\n"
            "- Be proximity-aware: when distances are provided, reference them succinctly in miles and/or kilometers.\n"
            "- CRITICAL: If the user specifies a distance constraint (e.g., 'within 5 miles', 'less than 3 km'), "
            "ONLY show results that meet that constraint. Exclude any results beyond the specified distance.\n"
            "- If ALL results exceed the user's distance constraint, explicitly say 'I couldn't find any [type] within [distance]' "
            "and optionally mention the closest option available if helpful.\n"
            ...
            "- Extract the timezone offset from the ISO format (e.g., -08:00, +05:30) and use it for all times\n"
            "- Parse natural language times into ISO 8601 format: YYYY-MM-DDTHH:mm:ss±HH:mm\n"
            ...
            "- EXAMPLES (if current time is 2025-11-05T20:30:00-08:00):\n"
            "  * 'today at 8pm' → 2025-11-05T20:00:00-08:00\n"
            "  * 'today at 8:30pm' or '8.30pm today' → 2025-11-05T20:30:00-08:00\n"
            "  * 'tomorrow at 11am' → 2025-11-06T11:00:00-08:00\n"
            "  * '11am' (no date specified) → 2025-11-05T11:00:00-08:00 (use today)\n"
            "  * '7pm' → 2025-11-05T19:00:00-08:00\n"
            "  * '12pm' or 'noon' → 2025-11-05T12:00:00-08:00\n"
            "  * '12am' or 'midnight' → 2025-11-05T00:00:00-08:00\n"
            "- CRITICAL: Always use YYYY-MM-DD from the current date for date calculations\n"
            "- CRITICAL: Always include the timezone offset (±HH:mm) in your iso_time output\n"
            "- CRITICAL: 11am means 11:00:00, NOT 12:00:00. Be precise with AM/PM.\n"
